...
## Задача решена без реверсивных функций путём среза по списку и возвращение обратно в строку.
# Далее сравнивались две части и если они были равны то вывод на экран что это полиндром